...
- Keep IDs normalized at the trust boundary.
...
Put page-specific code in the corresponding page module and shared policy in a small shared helper. Avoid after-the-fact global monkey patches; wire the behavior once in the original data/render path.
