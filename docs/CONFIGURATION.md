...
| --- | --- | --- |
| `BASE_URL` | Yes | HTTPS host under `dynamics.com`; Events API origin |
| `ORG_ID` | Yes | Non-empty bounded opaque identifier |
| `TOKEN` | Yes | Customer Insights web-application token |
